...
class UserFactory(DjangoModelFactory):
    ...
    Attributes:
        ...
        is_trainee (bool): Flag indicating if the user is a student.
        is_instructor_examiner (bool): Flag indicating if the user is a lecturer.
        is_parent (bool): Flag indicating if the user is a parent.
        is_operations (bool): Flag indicating if the user is a department head.
    """
    ...
    is_instructor_examiner: bool = False
...
class StudentFactory(DjangoModelFactory):
    ...
    student: User = SubFactory(UserFactory, is_trainee=True)
