...
class ProgramManager(models.Manager):
    def search(self, query=None):
        ...
        if query:
            or_lookup = Q(title__icontains=query) | Q(program_id__icontains=query)
...
class Program(models.Model):
    ...
    program_id = models.TextField(blank=False, null=False, default="00000")
